...
public class WhisperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button whisper = (Button) findViewById(R.id.button);
        final EditText msgText = (EditText) findViewById(R.id.editText);
        ...
        whisper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String base64 = Cipher.encryptoToBase64(msg, pwd);
                tv.setText(base64);
            }
        });
        // ATTENTION: This was auto-generated to implement the App Indexing API.
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Whisper Page") // TODO: Define a title for the content shown.
